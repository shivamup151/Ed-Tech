"use client"
import { Home, Settings2Icon, BookOpen, LogOut, TableOfContents, ClipboardCheck, ToolCase, UsersRound, BarChart3, AudioLines, History } from "lucide-react"
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const MENU_ITEMS = [
  ...
  { title: "Content-Generator", url: "/teacher/content-generation", icon: TableOfContents, },
  { title: "Assessment-Generator", url: "/teacher/assessment-builder", icon: ClipboardCheck, },
  ...
  { title: "History", url: "/teacher/history", icon: History, },
